...
function NewPortfolio(props) {
    return(
        <div>
            <a class="work-link" href="#work-link-anchor">
            <div className="portfolio-folder">
                ...
                <svg className="container-svg" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="-0px" width="300"
                height="200" viewBox="0 0 561 406.02" >
                <defs>
                </defs>
